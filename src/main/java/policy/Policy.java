 ...
 * Provides mutual exclusion using a semaphore to ensure that only one thread can fire a transition at a time.
 */
public abstract class Policy {
  /**
   * Semaphore to ensure thread-safe policy operations.
   * Protects access to policy state during transition evaluation and firing.
   */
